...
class CrayMpichBinary(Package):
    ...
    url = "file:///home/simon/cray-mpich-8.1.18.4-gcc.tar.gz"
    ...
    def fixup_compiler_paths(self):
        ...
        # Always link with the relevant gtl lib
        gtl_library = "-lmpi_gtl_cuda" if "+cuda" in self.spec else "-lmpi_gtl_hsa"
